...
- (void)validateLayout
{
    ...
    if (self.items.count > 0) {
        ...
        if (self.items.count == 2) {
            ...
            button.frame = CGRectMake(CONTENT_PADDING_LEFT + width + GAP-8, y, width+18, BUTTON_HEIGHT+10);
        } else {
...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
    ...
    [button setTitleColor:[UIColor colorWithHex:0xe15513] forState:UIControlStateNormal];
    [button setTitleColor:[UIColor colorWithHex:0xe15513  alpha:0.8] forState:UIControlStateHighlighted];
