...
//    [pController presentModalViewController: pickerController animated: YES];
    pickerController.navigationBar.tintColor = [UIColor colorWithRed:255/255.0 green:102/255.0 blue:0/255.0 alpha:1.0f];
//    [pickerController.navigationBar setTitleTextAttributes: [NSDictionary dictionaryWithObjectsAndKeys:
//                                                                                   [UIColor colorWithRed:1.0 green:102./255.0 blue:0.0 alpha:1.0],
...
//                                                                                   UITextAttributeFont,
//                                                             nil]];
    [pController presentViewController:pickerController animated:YES completion:^{
        NSLog(@"%@ " , pickerController.navigationItem.leftBarButtonItem);
        NSLog(@"%@ " , pickerController.navigationItem.rightBarButtonItem);
    }];
}
